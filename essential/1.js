...
window.addEventListener('load', hacking);
function hacking(){
	var c = document.getElementById("locoalien");
	c.height = c.height;  //innerHeight se utiliza para saber la altura de la pantalla
	c.width = c.width;    //innerHeight se utiliza para saber la altura de la pantalla
